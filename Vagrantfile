...
$num_instances = 1
$instance_name_prefix = "nw"
$update_channel = "beta"
$image_version = "877.1.0"
...
elsif ENV["NARWHAL_NUM_INSTANCES"].to_i > 0 && ENV["NARWHAL_NUM_INSTANCES"]
  $num_instances = ENV["NARWHAL_NUM_INSTANCES"].to_i
else
  $num_instances = 3
end
